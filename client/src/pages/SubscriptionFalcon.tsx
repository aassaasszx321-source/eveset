      ...
      <main className="py-20">
        <div className="container max-w-3xl">
          ...
          <div className="text-center mb-12">
            <img src="/assets/images/falcon-logo.png" alt="Falcon IPTV" className="h-20 w-auto mx-auto mb-6" />
            <h1 className="text-4xl md:text-5xl font-bold text-gradient-gold mb-4">
              صفحة مميزات اشتراكات فالكون الأصلي
            </h1>
          </div>
          ...
          <Card className="gold-border bg-card p-8 mb-12 space-y-6">
            <div>
              <h2 className="text-3xl font-bold text-accent mb-4">
                🚀 اشتراك فالكون الاصلي (Falcon IPTV) – دليلك الشامل للمباريات والترفيه اللامحدود! 🚀
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                افضل اشتراك iptv يجمع بين الشهرة، الثبات، والتنوع بدون تقطيع، سيرفر فالكون هو خيارك الأول والأقوى!
              </p>
            </div>

            <div>
              <h3 className="text-2xl font-bold text-accent mb-4">💡 لماذا تختار اشتراك (falcon iptv)؟</h3>
              <div className="space-y-4">
                <div className="flex gap-4">
                  <span className="text-2xl">🏁</span>
                  <div>
                    <h4 className="font-bold text-lg mb-2">أقوى اشتراك مباريات</h4>
                    <p className="text-muted-foreground">شاهد جميع المباريات والبطولات العالمية بث مباشر بوضوح تام وثبات ممتاز.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">مكتبة فيديو ضخمة ومتجددة تضم أحدث الأفلام والمسلسلات.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  <span className="text-2xl">🔒</span>
                  <div>
                    <h4 className="font-bold text-lg mb-2">جودة وثبات السيرفر الأصلي</h4>
                    <p className="text-muted-foreground">معروف بقوته واستقراره العالي جداً منذ سنوات طويلة.</p>
                  </div>
                </div>
              </div>
            </div>
