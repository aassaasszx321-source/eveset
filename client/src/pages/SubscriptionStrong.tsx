      ...
      <main className="py-20">
        <div className="container max-w-3xl">
          ...
          <div className="text-center mb-12">
            <img src="/assets/images/strong-logo.png" alt="Strong 4K" className="h-20 w-auto mx-auto mb-6" />
            <h1 className="text-4xl md:text-5xl font-bold text-gradient-gold mb-4">
              صفحة مميزات اشتراكات سترونق
            </h1>
          </div>
          ...
          <Card className="gold-border bg-card p-8 mb-12 space-y-6" dir="rtl">
            <div>
              <h2 className="text-3xl font-bold text-accent mb-4">
                🚀 اشتراك سترونق (Strong 4K / 8K IPTV) – دليلك الشامل للمباريات والترفيه اللامحدود! 🚀
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                إذا كنت تبحث عن افضل اشتراك iptv يجمع بين الدقة الخارقة، الثبات، والتنوع بدون تقطيع، فإن اشتراك سترونق هو خيارك الأول والأقوى في السوق حاليًا!
              </p>
            </div>

            <div>
              <h3 className="text-2xl font-bold text-accent mb-4">💡 لماذا تختار اشتراك فوركي سترونج؟</h3>
              <div className="space-y-4">
                <div className="flex gap-4">
                  <span className="text-2xl flex-shrink-0">🏁</span>
                  <div>
                    <h4 className="font-bold text-lg mb-2">أقوى اشتراك مباريات بدقة فائقة</h4>
                    <p className="text-muted-foreground">شاهد جميع البطولات حصرياً بأعلى دقة ممكنة (<span dir="ltr">4K/8K</span>) وثبات تام.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  <span className="text-2xl flex-shrink-0">🎬</span>
                  <div>
                    <h4 className="font-bold text-lg mb-2">أكبر اشتراك مسلسلات وأفلام سينمائية</h4>
                    <p className="text-muted-foreground">مكتبة فيديو ضخمة ومتجددة (<span dir="ltr">VOD</span>) تضم أحدث الأفلام والمسلسلات بأعلى نقاوة.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  <span className="text-2xl flex-shrink-0">🔒</span>
                  <div>
                    <h4 className="font-bold text-lg mb-2">جودة وثبات سيرفرات سترونق</h4>
                    <p className="text-muted-foreground">يعتمد السيرفر على بنية تحتية عملاقة توفر جودة حقيقية ومستقرة تماماً.</p>
                  </div>
                </div>
              </div>
            </div>
